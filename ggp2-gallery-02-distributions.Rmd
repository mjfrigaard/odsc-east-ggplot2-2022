...
```{r plot-geom_freqpoly, ref.label='geom_freqpoly', echo=FALSE, fig.align='center', out.width='85%', out.height='85%'}
```
...
```{r plot-geom_dotplot-stackgroups, ref.label='penguins_histodot_stackgroups', echo=FALSE, fig.align='center', out.width='81%', out.height='81%'}
```
...
```{r plot-geom_beeswarm, ref.label='geom_beeswarm', echo=FALSE, fig.align='center', out.width='90%', out.height='90%'}
```
...
```{r plot-geom_density_ridges, ref.label='geom_density_ridges', echo=FALSE, fig.align='center', out.width='90%', out.height='90%'}
```
...
```{r plot-geom_boxplots, ref.label='geom_boxplots', echo=FALSE, fig.align='center', out.width='90%', out.height='90%'}
```
...
```{r boxplot-comparisons, echo=FALSE, fig.align='center', out.width='75%', out.height='75%'}
