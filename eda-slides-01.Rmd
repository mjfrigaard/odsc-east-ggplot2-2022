...
More geoms and aesthetic mappings  

.code50[

```{r template-02, eval=FALSE, echo=TRUE}
ggplot(data = <DATA>) +
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) + 
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) #<<
```
...
```{r template-03, eval=FALSE, echo=TRUE}
ggplot(data = <DATA>) +
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) + 
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) +
     facet_* #<<
...
```{r template-04, eval=FALSE, echo=TRUE}
ggplot(data = <DATA>) +
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) + 
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) +
     facet_* + 
...
```{r template-05, eval=FALSE, echo=TRUE}
ggplot(data = <DATA>) +
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) + 
     geom_*(mapping = aes(<AESTHETIC MAPPINGS>)) +
     facet_* + 
