...
```{r data-layer-png, echo=FALSE, eval=TRUE, fig.align='center', out.height='70%', out.width='70%'}
...
```{r mapping-layer-png, echo=FALSE, eval=TRUE, fig.align='center', out.height='75%', out.width='75%'}
...
```{r geom-layer-png, echo=FALSE, eval=TRUE, fig.align='center', out.height='75%', out.width='75%'}
...
```{r multiple-layers-png, echo=FALSE, eval=TRUE, fig.align='center', out.height='70%', out.width='70%'}
...
> .blue[“making infinite use of finite means.”] - [Wilhelm von Humboldt](https://en.wikipedia.org/wiki/Wilhelm_von_Humboldt)
