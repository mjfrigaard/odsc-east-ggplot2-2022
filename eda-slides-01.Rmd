...
### **.fancy[Syntax]:** the form, structure and order for the construction of statements 
...
### With a finite number of .blue[objects] & .red[functions], we can use `ggplot2`s grammar and syntax to create an infinite number of graphs!
